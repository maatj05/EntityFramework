    ...
    public class SqlServerUpdateSqlGenerator : UpdateSqlGenerator, ISqlServerUpdateSqlGenerator
    {
            ...
            string orderColumn = null)
        {
            ...
            commandStringBuilder
                ...
                .Append(" i")
                .Append(" ON ")
                .AppendJoin(keyOperations, (sb, c) => sb
                    .Append("(")
                    .Append(SqlGenerationHelper.DelimitIdentifier(c.ColumnName, "t"))
                    .Append(" = ")
                    .Append(SqlGenerationHelper.DelimitIdentifier(c.ColumnName, "i"))
                    .Append(")"), " AND ");
            ...
            if (orderColumn != null)
            {
                commandStringBuilder
                    .AppendLine()
                    .Append("ORDER BY ")
                    .Append(SqlGenerationHelper.DelimitIdentifier(orderColumn, "i"));
            }
